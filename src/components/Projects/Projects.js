        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              repolink="https://github.com/Kadargo63/Kadargo63.github.io"
              link="https://kadargo63.github.io/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="MERN stack single-page application that works with real-world data to solve a real-world challenge, with a focus on user demandMERN. This inventory management app is built to client specifications by team of 4 developers."
              repolink="https://github.com/Kadargo63/excelsior-inventory"
              link="https://shrouded-forest-00815.herokuapp.com/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              repolink="https://github.com/pfrueh1/SuperFan"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              repolink="https://github.com/Kadargo63/blog-tas-tech"
              link="https://calm-eyrie-37959.herokuapp.com/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              repolink="https://github.com/Kadargo63/budgie-budget"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              repolink="https://github.com/Kadargo63/weather-or-not"
            />
          </Col>
        </Row>
      </Container>
